...
// and re-insert it into any other template later without redoing the
...
const STORAGE_KEY = 'vantly-mailer-builder:saved-blocks';
...
export function getSavedBlocks(): SavedBlock[] {
  ...
  try {
    ...
    // throwing and breaking the whole designer over a saved-blocks glitch.
    return [];
  }
}
