...
interface MenuItemInterface {
  ...
  onClick?: () => void;
  // Gated on the platform-wide isSuperAdmin flag (Admin Panel access),
  // separate from `role` above which is the per-organization USER/ADMIN/
  // SUPERADMIN role - a superadmin who is only a plain USER of the org
  // they're currently viewing should still see this link.
...
export const useMenuItem = () => {
  ...
  const firstMenu = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M10 1.5V4M10 16V18.5M18.5 10H16M4 10H1.5M15.6066 4.39339L13.8891 6.11091M6.11091 13.8891L4.39339 15.6066M15.6066 15.6066L13.8891 13.8891M6.11091 6.11091L4.39339 4.39339M13.5 10C13.5 11.933 11.933 13.5 10 13.5C8.067 13.5 6.5 11.933 6.5 10C6.5 8.067 8.067 6.5 10 6.5C11.933 6.5 13.5 8.067 13.5 10Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  const secondMenu = [
    ...
    },
    {
      ...
      path: 'https://affiliate.vantly.social',
      role: ['ADMIN', 'SUPERADMIN', 'USER'],
      requireBilling: true,
    },
    {
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M10 2.16699L16.6667 5.08366V9.91699C16.6667 13.9503 13.775 17.5586 10 18.8337C6.225 17.5586 3.33333 13.9503 3.33333 9.91699V5.08366L10 2.16699Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
...
export const TopMenu: FC = () => {
  ...
  return (
    <>
      <div className="flex flex-1 flex-col gap-[8px] minCustom:gap-[16px] custom:gap-[8px] blurMe">
        {
          // @ts-ignore
          user?.orgId &&
            // @ts-ignore
      ...
      <div className="flex flex-col gap-[8px] minCustom:gap-[16px] custom:gap-[8px] blurMe">
        {secondMenu
          .filter((f) => {
            if (f.hide) {
              return false;
