  ...
  return [
      ...
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'Vantly' : 'Gitroom'}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'Vantly' : 'Gitroom'
        } is proudly open-source! We believe in an ethical and transparent culture, meaning that ${
          isGeneral ? 'Vantly' : 'Gitroom'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/Sangwan70/social_media_promotion" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
