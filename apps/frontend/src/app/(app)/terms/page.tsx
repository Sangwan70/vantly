...
// See privacy/page.tsx's own doc comment - same DB-override-with-
// hardcoded-fallback contract, same force-dynamic tradeoff.
...
export default async function TermsPage() {
  ...
  if (override?.contentHtml) {
    ...
    return (
      <LegalPageLayout title={override.title || 'Terms of Service'} lastUpdated={lastUpdated}>
  ...
  return (
    <LegalPageLayout title="Terms of Service" lastUpdated={FALLBACK_LAST_UPDATED}>
      {FALLBACK_CONTENT}
    </LegalPageLayout>
  );
}
